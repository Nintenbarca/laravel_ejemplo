        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('examenes.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('fecha') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fecha" type="text" class="form-control" name="fecha" value="{{ old('fecha') }}" placeholder="dd/mm/aaaa" required autofocus>
