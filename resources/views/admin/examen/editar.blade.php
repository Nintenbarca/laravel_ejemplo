        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ Form::model($examen, array('route' => array('examen.update', $examen->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    @foreach($preguntas as $pregunta)
                        {{ Form::model($pregunta, array('route' => array('pregunta.update', $pregunta->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('pregunta.store') }}">
                        {{ csrf_field() }}
